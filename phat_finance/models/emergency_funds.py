...
class EmergencyFund(models.Model):
    ...
    @transaction.atomic
    def __fund_deposit(self, redis_client: Redis, amount: int) -> None:
        """
    ...
    @transaction.atomic
    def __fund_withdraw(self, redis_client: Redis, amount: int) -> None:
        """
    ...
    def save(self, *args, **kwargs):
        if self.type == "deposite":
            self.__fund_deposit(redis, self.amount)
        elif self.type == "withdraw":
            self.__fund_withdraw(redis, self.amount)
